      ...
      <div className="max-w-5xl mx-auto px-4 md:px-6 pb-3 pt-3">
        <div
          className={cn(
            ...
            'rounded-xl',
            isScrolled
              ? 'shadow-[0_18px_60px_rgba(42,38,35,0.10)] border-white/50'
              : 'shadow-[0_10px_40px_rgba(42,38,35,0.06)] border-white/40',
          )}
        >
            ...
            <div className="hidden md:flex flex-1 items-center justify-between">
              <nav className="flex items-center gap-1">
                ...
                >
                  <Link
                    href="/products"
                    className="hover:bg-[#f3f1ec] text-[15px] font-semibold px-3 py-2 rounded-3xl transition-colors inline-flex items-center gap-1"
                  >
                    Products
                  ...
                  <div className={cn(
                    ...
                    <div className="w-[720px] rounded-2xl bg-white border border-warm-200/80 shadow-[0_20px_60px_rgba(42,38,35,0.10)] p-4">
                          ...
                          <div key={group.label}>
                            ...
                            {group.items.map((item) => (
                              <Link
                                ...
                                className="flex items-center gap-2 rounded-3xl px-1.5 py-1.5 hover:bg-warm-50 transition-colors group"
                              >
                ...
                >
                  ...
                  <div className={cn(
                    ...
                    <div className="w-[400px] rounded-2xl bg-white backdrop-blur-xl border border-warm-200/80 shadow-[0_20px_60px_rgba(42,38,35,0.10)] p-4">
                      {solutions.map((item) => (
                        <Link
                          key={item.name}
                          href={item.href}
                          onClick={() => setActiveDropdown(null)}
                          className="flex items-start gap-3 rounded-3xl px-2.5 py-2.5 hover:bg-warm-50 transition-colors group"
                        >
                          <div className="flex items-center justify-center w-9 h-9 rounded-3xl bg-primary/8 shrink-0 mt-0.5 group-hover:bg-primary/15 transition-colors">
                ...
                <Link
                  href="/pricing"
                  className="hover:bg-[#f3f1ec] text-[15px] font-semibold px-3 py-2 rounded-3xl transition-colors"
                >
                  Pricing
                </Link>
                <Link
              ...
              <div className="flex items-center gap-2">
                <Link href="https://app.forkhr.com/login" target="_blank">
                  <Button variant="ghost" className="text-[15px] text-dark hover:text-dark/80 hover:bg-transparent">
                    Sign in
                    <ArrowRight className="w-4 h-4 ml-1" />
                  </Button>
                </Link>
                <Link href="https://app.forkhr.com/register" target="_blank">
                  <Button className="text-[15px] glass-shine text-white">Get started</Button>
                </Link>
              </div>
            </div>
                ...
                <SheetContent className="flex flex-col p-0 w-full bg-white backdrop-blur-xl overflow-y-auto">
                  ...
                  <div className="flex-1 overflow-y-auto">
                    ...
                    <button
                      ...
                      className="w-full py-4 border-b border-warm-100 text-warm-800 font-semibold text-lg flex items-center justify-between px-4 hover:text-primary transition-colors"
                    >
                      Products
                    ...
                    <Link
                      href="/pricing"
                      onClick={() => setOpen(false)}
                      className="py-4 border-b border-warm-100 text-warm-800 font-semibold text-lg flex items-center px-4 gap-2 hover:text-primary transition-colors"
                    >
                      Pricing
                    </Link>
                    <Link
