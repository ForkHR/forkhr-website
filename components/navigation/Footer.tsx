...
const productLinks = [
  ...
  { label: 'Incidents', href: '/products#incidents' },
  { label: 'Violations & terminations', href: '/products#violations-terminations' },
  ...
  return (
    <footer className="border-t border-warm-200 bg-white/60 backdrop-blur-sm">
      <div className="max-w-5xl mx-auto px-4 md:px-6 py-16">
        ...
        {/* Bottom bar */}
        <div className="mt-14 pt-6 border-t border-warm-200 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-warm-400">
            &copy; {new Date().getFullYear()} Fork Workforce Inc. All rights reserved.
          </p>
          <div className="flex items-center gap-4">
            <Link href="/privacy-policy" className="text-xs text-warm-400 hover:text-warm-600 transition-colors">
              Privacy
            </Link>
            <Link href="/terms-of-service" className="text-xs text-warm-400 hover:text-warm-600 transition-colors">
              Terms
            </Link>
          </div>
        </div>
