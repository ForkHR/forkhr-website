...
const Footer = () => {
    return (
        <footer className="text-center border-t-slate-200 border-t bg-white border-dashed">
            <div className="max-w-[800px] mx-auto w-full flex flex-col border-r border-l border-slate-200 border-dashed">
                <div className="flex gap-4 justify-between md:pb-20 md:flex-row flex-col md:px-8 px-4 md:py-20 py-10">
                    ...
                    <div className="flex flex-col gap-4 md:items-center md:pt-0 pt-8 md:max-w-[150px] w-full">
                        ...
                        <div className="flex md:flex-col gap-2 w-full md:max-w-[125px]">
                            <Link href="https://apps.apple.com/us/app/fork-hr-scheduling/id6754656709"
                            ...
                            <Link href="https://play.google.com/store/apps/details?id=com.forkhr.fork"
                                className="w-full hover:opacity-70"
                                target="_blank"
                            >
                                <Image
                        ...
                        <div className="flex md:flex-col gap-2">
                            <Link href="https://app.forkhr.com/login" className="w-full">
                            ...
                            <Link href="https://app.forkhr.com/register" className="w-full">
                                <Button
                ...
                <div className="max-w-[800px] mx-auto w-full flex flex-col border-l border-r border-slate-200 py-4 md:py-8 border-dashed">
                    <div className="flex gap-2 md:justify-between md:items-center md:px-8 px-4 flex-col md:flex-row">
                        ...
                        <div className="text-xs text-start md:text-end text-gray-400">
                            <p>Fork Workforce Inc. &copy; {new Date().getFullYear()} <br /> All rights reserved</p>
                        </div>
                    </div>
                </div>
            </div>
