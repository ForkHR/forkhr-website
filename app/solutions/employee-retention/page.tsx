          ...
          <div className="grid sm:grid-cols-3 gap-4 max-w-3xl mb-8">
            {turnoverCost.map((row) => (
              <div key={row.role} className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-5">
                <div className="text-sm font-semibold text-warm-400 mb-1">{row.role}</div>
                <div className="text-3xl font-bold text-red-400 mb-2">{row.cost}</div>
                <div className="text-sm text-warm-500">{row.detail}</div>
              </div>
            ))}
          </div>

          <div className="rounded-2xl border border-amber/20 bg-amber/5 p-6 max-w-3xl">
            <div className="text-sm text-warm-400 mb-1">
        ...
        <div className="max-w-5xl mx-auto px-6 py-20 md:py-28">
          ...
          <div className="grid sm:grid-cols-2 gap-3 max-w-3xl">
            {retentionDrivers.map((d) => (
              <div key={d.driver} className="flex items-center justify-between bg-white rounded-xl px-5 py-4 border border-warm-200">
                <div className="flex items-center gap-3">
                  <CheckCircle2 className="w-4 h-4 text-primary shrink-0" />
                  <span className="text-sm font-medium text-warm-700">{d.driver}</span>
                </div>
