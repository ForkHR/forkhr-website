...
import { ArchiveIcon, HamburgerMenuIcon, InfoCircledIcon } from '@radix-ui/react-icons';
import { ArrowRight, ArrowUpRight, BackpackIcon, ShoppingBag, UsersIcon } from 'lucide-react';
                ...
                <div className='flex h-16 max-w-screen-2xl items-center'>
                    <div className="flex items-center">
                        <NavLink to="/" className='mr-4 items-center gap-1'>
                            <svg viewBox="0 0 345 100" height="28px" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {/* {windowWidth > 980 ? */}
                            <div className="flex items-center gap-1 text-sm">
                                <NavLink to="/pricing">
                                    <Button variant="text" className="text-base hover:text-primary">
                                        Pricing
                                    </Button>
                                </NavLink>
                            </div>
